...
var getList = function () {
  // var url = "http://116.62.93.251/?s=42|17&p=yhSystemTheme&k=1&v=1&specialId=204637&c=11"
  // var url =  "http://112.17.251.186:10088/?s=42|17&p=yhNavigationBar&k=1&v=1&catId=205697&c=17"
  var url = "http://112.17.251.186:10088/?s=42|17&p=yhSpecialList_nc&k=1&v=1&catId=205697&c=17"
  unity.jsonp(url, function (res) {
    console.log("获取推荐资产");
    console.log(JSON.stringify(res));//{"code":200,"data":{"layout":"Home","jsonUrl":"http://112.17.251.186:10088/?s=42|17&p=yhNavigationBar&k=1&v=1&catId=205685&c=17"},"message":"请求成功"}
  //  value.cList = res.data.elementList.splice(0, 8)
    value.cList = res.data.specialList[2].elementList.splice(0, 8)
...
var getSearchData = function (keyword, pindex) { 
  var url = "http://116.62.93.251/?s=42|17&p=yhSearch&k=1&v=1&searchType=all&word=" + keyword + "&pindex=" + pindex + "&psize=8"
  unity.jsonp(url, function (res) {
    console.log("获取搜索资产");
    console.log(res);
    $(".top-c").css({
