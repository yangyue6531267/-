...
var starvServerURL = {
  contentInfo: 'http://112.18.251.100:8001/sichuanC?sichuanEvent=sr.cp_content_info&&&',
  userVod: 'http://112.18.251.100:8001/sichuanU?sichuanEvent=sr.cp_user_vod&&&',
  pageclick: 'http://112.18.251.100:8001/sichuanP?sichuanEvent=sr.cp_panel_click&&&',
  exposure: 'http://112.18.251.100:8001/sichuanE?sichuanEvent=sr.cp_exposure&&&'
}
  ...
  try {
    if (type == '200') {
      ...
      if (type == '01') {
        ...
        starVGf.setCookie('STARV_IP', '0:0:0:1') // 机顶盒IP
