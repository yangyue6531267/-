...
var starvServerURL = {
  contentInfo: 'http://112.18.251.100:8001/sichuanC?sichuanEvent=dj.cp_content_info&&&',
  userVod: 'http://112.18.251.100:8001/sichuanU?sichuanEvent=dj.cp_user_vod&&&',
  pageclick: 'http://112.18.251.100:8001/sichuanP?sichuanEvent=dj.cp_panel_click&&&',
  exposure: 'http://112.18.251.100:8001/sichuanE?sichuanEvent=dj.cp_exposure&&&'
}
  ...
  try {
    if (type == '200') {
      ...
      if (type == '01') {
        ...
        starVGf.setCookie('STARV_IP', '0:0:0:1');
