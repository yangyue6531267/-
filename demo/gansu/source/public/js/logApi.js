...
// var logAddress = 'http://winnow-bs.yanhuamedia.tv/yanhua';//测试地址
// var logAddress = 'http://47.96.135.84:8001/logCollect';//测试地址
...
function commonParams() {
  ...
  this.user_id = Cookies.get('mobileNo') // 用户唯一ID
  this.device_id = Cookies.get('msgid') // 设备号deviceid，唯一
  this.province = encodeURIComponent('甘肃') // 省份
  this.vip = '0'
