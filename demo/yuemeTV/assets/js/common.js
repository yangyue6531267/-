...
function toast(msg) {
  ...
  div1.style.cssText = "display: inline-block;background: rgba(1, 1, 1, 0.6);color: rgb(255, 255, 255);padding: 10px;min-width: 12px;text-align: center;font-size: 22px;border-radius: 5px;width: 100%;overflow-wrap: break-word;";
