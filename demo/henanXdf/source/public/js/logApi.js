...
var logAddress = 'http://112.35.185.113:19001/yanhua';//正式地址
function bi() {
...
function commonParams() {
  ...
  this.province = encodeURIComponent('河南') // 省份
  this.vip = '0'
...
function logup(jsonOb) {
  jsonOb = eval('(' + jsonOb + ')')
  console.log('BI log:' + JSON.stringify(jsonOb))
