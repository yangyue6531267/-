...
if (getQueryString('specialId')) {
  //外链跳转专题页面
  special.url =  'http://112.35.185.113:18081/?s=39|25&p=yhSpecialDetail&k=1&v=1&topicId='+getQueryString("specialId")+'&c=25';
  if(Cookies.get('twoStageBackUrl')){
    Cookies.del('twoStageBackUrl','/')
  };
...
function collectData() {
  ...
  // console.log(url);
  getCollectionList(url, function (res) {
    // console.log(res);
