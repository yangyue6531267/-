...
var getData = function (type, pindex, psize) {
  var url = 'http://112.17.251.186:10088/?s=43|27&p=yhScreenResult&k=1&v=1&catCode=' + value.keyword + '&content=' + type + '&pindex=' + pindex * 8 + '&psize=' + psize + '&sizeFlag=1';
  // var url = 'http://winnow-ds.yanhuamedia.tv/?s=14|2&p=yhScreenResult&k=1&v=1&catCode=' + value.keyword + '&content=' + type + '&pindex=' + pindex * 8 + '&psize=' + psize + '&sizeFlag=1';
  unity.jsonp(url, function (res) {
    ...
    for (var i = 0; i < value.detailData.length; i++) {
      $(".scroll-box").append('<li><div class="imgbox"><div class="score"><span>' + value.detailData[i].score + '</span></div><img class="lazyload" src="../public/images/1img_loading_160x230.png"  data-img="' + value.detailData[i].assetImg + '"/></div><div class="word">' + value.detailData[i].assetName + '</div></div></li>');
    }
    $.imgLazyLoad();
