...
var getList = function () {
  var url = "http://112.17.251.186:10088/?s=43|27&p=yhSpecialDetail&k=1&v=1&specialId=204637&c=11"
...
var getSearchData = function (keyword, pindex) {
  ...
  var url = "http://112.17.251.186:10088/?s=43|27&p=yhSearch&k=1&v=1&searchType=all&word=" + keyword + "&pindex=" + pindex + "&psize=8"
  unity.jsonp(url, function (res) {
    console.log("获取搜索资产");
    console.log(res);
    $(".top-c").css({
...
var searchBox = {
  ...
  init: function (data) {
    ...
    $(".scroll-box").empty();
    for (i in this.data) {
      $(".scroll-box").append('<li><div class="imgbox"><div class="score"><span>' + this.data[i].score + '</span></div><img class="lazyload" src="../public/images/1img_loading_160x230.png"  data-img="' + this.data[i].elementImg + '"/></div><div class="word">' + this.data[i].elementName + '</div></li>')
    }
