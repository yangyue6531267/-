var value = {
  ...
  getValue: function () {
    ...
    var jsonUrl = 'http://112.17.251.186:10088/?s=43|27&p=yhNavigationBar&k=1&v=1&catId=205748&c=27'
...
var getContent = function (navNum) {
  ...
  unity.jsonp(url, function (res) {
    ...
    // value.detailData = res.data.catList;
    topCommend.init();
    if (navNum === 0) {
...
var topCommend = {
  ...
  init: function () {
    ...
    $(".topCommend").append('<li class="bigCommend"><img class="lazyload" src="../public/images/1img_loading_352x190.png" data-img="' + this.data[0].elementImg + '"/></li><ul></ul>')
    for (var i = 1; i < 5; i++) {
      $('.topCommend ul').append('<li><img class="lazyload" src="../public/images/1img_loading_352x190.png" data-img="' + this.data[i].elementImg + '"/></li>')
    }
...
var specialSubject = {
  ...
  init1: function () {
    ...
    for (i in this.data) {
      $('.special-subject ul').append('<li class="specialLi"><img class="lazyload" src="../public/images/1img_loading_352x190.png" data-img="' + this.data[i].elementImg + '"/></li>')
    }
...
var assetList1 = {
  ...
  init: function () {
    ...
    for (var i = 0; i < 11; i++) {
      $(".assetList1 ul").append('<li><div class="imgbox"><div class="score"><span>' + this.data.elementList[i].score + '</span></div><img class="lazyload" src="../public/images/1img_loading_160x230.png"  data-img="' + this.data.elementList[i].elementImg + '"/></div><div class="word">' + this.data.elementList[i].elementName + '</div></li>')
    }
