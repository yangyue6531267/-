...
function unifiedOrder(contentId) {
  ...
  var productId = "";
  // var productId = "8801000014,9901000027";
  var backUrl = window.location.href;
  var channelId = "bestv";//收银台返回
  // var backUrl = "http://112.17.251.186:10089/fujian/source/detail/detail.html";
  var orderUrl = orderBaseUrl + "?subContentId=&copyRightContentId=&path=&preview=&channelId=" + channelId + "&productId=&userId=" + userId + "&terminalId=" + terminalId +
