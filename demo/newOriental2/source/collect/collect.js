...
collect_Content.init = function(){
  collect_Content.collect_list = groupingArr(value.detailData.resultList,'relateCategory');
  // if( this.collect_list.length ){
  //   if( this.collect_list.length == 1 ){
  //     rowDiff = 126
  //   } else {
  //     rowDiff = parseInt((370  + (130 / this.collect_list.length - 1)));
  //   }
  // }
