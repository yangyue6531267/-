...
var getData = function (navNum) {
  ...
  unity.jsonp(url, function (res) {
    ...
    $(".indexPage").css('background-image','linear-gradient(54deg, #476E8E, #4D828E)')
...
var getContent = function (navNum) {
  ...
  switch (navNum) {
    case 0:
      $(".indexPage").css('background-image','linear-gradient(144deg, #476E8E, #4D828E)')
    case 1:
      $(".indexPage").css('background-image','linear-gradient(168deg, #418484, #0E5480)')
    case 2:
      $(".indexPage").css('background-image','linear-gradient(168deg, #66879C, #3E7984)')
    case 3:
      $(".indexPage").css('background-image','linear-gradient(144deg, #C95E5E, #C9BA68)')
    case 4:
      $(".indexPage").css('background-image','linear-gradient(168deg, #947CA8, #684D76)')
    case 5:
      $(".indexPage").css('background-image','linear-gradient(168deg, #8A906C, #1C707B)')
    default:
      break
  }
  unity.jsonp(url, function (res) {
