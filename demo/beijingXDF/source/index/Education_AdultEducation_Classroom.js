...
adultEducation_Classroom.left = function () {
  if (this.pos === 0) {
    if (this.itemNo == 0) {
      ...
      primaryAdvanced_Classroom.itemNo = 5;
      primaryAdvanced_Classroom.pos = this.pos;
    ...
    if (this.itemNo == 0) {
      if (Home.itemNo == 0) return
      primaryAdvanced_Classroom.itemNo = 7;
      primaryAdvanced_Classroom.pos = this.pos;
      removeClass(Home.getCurr(), 'select');
      Home.itemNo--;
      toggleClass(Home.getCurr(), 'select');
...
adultEducation_Classroom.enter = function () {
  ...
  if (this.pos === 1 && this.itemNo === 5) {
    ...
    window.location.href = '../filter/filter.html?catCode=cjkt';
    return;
  }
